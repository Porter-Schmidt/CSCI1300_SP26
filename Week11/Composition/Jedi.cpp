...
// NOTE If I had passed a saber object, I would not need to use the initializer list
...
// Use initializer list instead:
Jedi::Jedi(string nameInput, int h, int m, int d, int a, string saberColor, double powerLevel)
    : name(nameInput),
      health(h),
      mana(m),
      defense(d),
      attack(a),
      saber(saberColor, powerLevel)
{}
